...
//void Hardware_USART3_IRQHandler(void)
//{
//    if (USART_GetITStatus(USART3, USART_IT_RXNE) != RESET)
//    {
//        atk_mb026_uart_rx_restart();
//        uint8_t received_data = USART_ReceiveData(USART3);
//        atk_mb026_uart_printf("Received: %c", received_data);
//    }
//}



//void Hardware_TIM2_IRQHandler(void)
//{
//    if (TIM_GetITStatus(TIM2, TIM_IT_Update) != RESET)
//    {
//        TIM_ClearITPendingBit(TIM2, TIM_IT_Update);
//        atk_mb026_uart_printf("Timer Interrupt Occurred\r\n");
//    }
//}
...
//void USART3_IRQHandler(void)
//{
//    Hardware_USART3_IRQHandler();
//}

//void TIM2_IRQHandler(void)
//{
//    Hardware_TIM2_IRQHandler();
//}
